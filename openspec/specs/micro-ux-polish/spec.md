...
Small UX improvements that individually take <15 minutes to implement but collectively improve the user experience: sparkline tooltips, keyboard navigation on PR tabs, recovery progress bar for incomplete baseline, realistic skeletons, and smooth chart transitions.
