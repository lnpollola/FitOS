...
Provide a standardized CSS component for all tabular data displays across the application, replacing 16 bare `<table>` instances with a unified organic visual identity. The component encompasses `.data-table-wrapper`, `.data-table`, `.data-table--sticky-col`, and `.data-table-pagination`.
