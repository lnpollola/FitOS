...
Set target weight-loss pace, compute deficit from TDEE, evaluate adherence using trend weight and body measurements, and generate slot-level gram adjustment recommendations with safety constraints.
