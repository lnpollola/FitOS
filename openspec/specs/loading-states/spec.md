...
Display skeleton placeholders during async IPC data loads with streaming render via `Promise.allSettled`, and loading button states for async actions. Provide `aria-live` regions for screen reader announcements.
