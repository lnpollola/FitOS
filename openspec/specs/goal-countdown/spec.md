...
Compute and display the number of days remaining until a goal's target date, with color-coded urgency levels to motivate the user as the deadline approaches.
