...
Render a Chart.js line chart showing the 28-day rolling weight-delta rate from weight entries over the trailing 180 days, with a reference line from the user's target pace and PR weight annotation.
