...
Display a compact summary of active goals on the dashboard, showing up to 3 progress rings in a horizontal row between the Strava-style summary panels and the hero card. Each ring is clickable to navigate to the goals view.
