...
Move the auto-insights section from the insights view to the dashboard, rendering compact insight cards between the Strava panels block and the hero card.
