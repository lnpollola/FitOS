...
Show total training minutes and session count for each weekday from sport activities as a 7-bar Chart.js histogram with a highlighted best day.
...
- **THEN** the histogram SHALL render with a caveat caption: "Patrón partial (X semanas de datos)"
